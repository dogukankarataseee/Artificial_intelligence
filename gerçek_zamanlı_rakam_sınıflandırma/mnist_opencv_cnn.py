...
import numpy as np
import cv2
import os  # Veri içeri aktarmak için kullanıllır
from sklearn.model_selection import train_test_split # veriyi train ve test olmak üzere ikiye ayırıyor
from sklearn.metrics import confusion_matrix
import seaborn as sns  # Veri Görselleştirme 
import matplotlib.pyplot as plt # Veri Görselleştirme
from keras.models import Sequential # Taban
from keras.layers import Dense, Conv2D, MaxPooling2D, Flatten, Dropout, BatchNormalization
from keras.utils import to_categorical
from keras.preprocessing.image import ImageDataGenerator
import pickle # Modeli yüklemek için kullanılır

path = "myData" # Farklı kalıptaki sayı datalar mevcut

myList = os.listdir(path) # path içinde bulunan dataları değikene atıyoruz.
...
images = np.array(images) # array yapısına çeviriyoruz
...
# verileri görselleştirme (içerikte ne kadar sayının olduğunu grafiksel öğreniyoruz)
...
x_train = np.array(list(map(preProcess, x_train))) # Resimleri büyütmek için
